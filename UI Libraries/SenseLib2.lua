...
function Library:CreateTab(tabtitle, tabdescription)
    ...
    function Utilities:CreateSection(sectionname)
    ...
    function Utilities:CreateCheckbox(checkboxname, action)
    ...
    function Utilities:CreateButton(buttonname, action)
...
Button.MouseButton1Down:Connect(function()
    ...
    function Utilities:CreateTextbox(holdtext ,boxname, action)
        local Button = Instance.new("TextBox")

        Button.Name = (boxname .. "Button")
        Button.Parent = TabNameBody
        Button.BackgroundColor3 = Library.Colors.Button
        Button.BorderColor3 = Library.Colors.Border
        Button.BorderSizePixel = 0
        ...
        Button.Size = UDim2.new(0, 200, 0, 30)
        Button.Font = Library.Settings.MainTextFont
		Button.PlaceholderText = holdtext
		Button.PlaceholderColor3 = Library.Colors.Holdertext
        Button.Text = boxname
        Button.TextColor3 = Library.Colors.TextboxColor
        Button.TextSize = Library.Settings.MainTextSize
...
Button.Changed:connect(function()
    ...
    function Utilities:CreateColorPicker(colorpickername, colorpickerpresetcolor, action)
        ...
        ColorPickerTitleText.Font = Enum.Font.Code
        ...
        ColorPickerButton.MouseButton1Click:Connect(function()
            if not ColorPickerMainOpen then
                ...
                TweenService:Create(ColorPickerMain, TweenInfo.new(Library.Settings.ColorPickerTweenTime, Library.Settings.TweenEasingStyle, Enum.EasingDirection.Out), {Size = UDim2.new(0, 200, 0, 160)}):Play()
    ...
    function Utilities:CreateSlider(slidername, minimumvalue, maximumvalue, startvalue, precisevalue, action)
    ...
    function Utilities:CreateDropdown(dropdownname, dropdownlistoptions, dropdownlistpresetnumber, action)
